public class MapArray {
    ...
    public static void initializeMapValues()
    {
        ...
        mapStyle[22][c] = CYAN21; mapText[22][c] = "¬»  (19)";
        ...
        mapStyle[11][c] = PLAYER1_21L; mapText[11][c] = "»„‡˜ 1";
        ...
        mapStyle[24][4] = WINNER63; mapText[24][c] = "«‡ ÔÓ·Â‰‡ Â ‰ÓÒÚ‡Ú˙˜ÌÓ Ë Ô˙‚ ‰‡ Á‡ÍÛÔËÚÂ 9 Ó·ÂÍÚ‡!"; //Field last action
        mapStyle[25][c] = BLACK21L; mapText[25][c] = "";
        ...
        mapStyle[10][c] = BLACK21; mapText[10][c] = "";
        mapStyle[11][c] = PLAYER2_21L; mapText[11][c] = "»„‡˜ 2";
        ...
        mapStyle[10][c] = BLACK21; mapText[10][c] = "";
        mapStyle[11][c] = PLAYER3_21L; mapText[11][c] = "»„‡˜ 3";
